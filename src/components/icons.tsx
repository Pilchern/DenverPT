export function DumbbellIcon({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect x="0" y="6" width="4" height="8" rx="1" fill="currentColor" />
      <rect x="5" y="3" width="4" height="14" rx="1" fill="currentColor" />
      <rect x="27" y="8.5" width="10" height="3" fill="currentColor" />
      <rect x="55" y="3" width="4" height="14" rx="1" fill="currentColor" />
      <rect x="60" y="6" width="4" height="8" rx="1" fill="currentColor" />
    </svg>
  );
}
...
export function SproutIcon({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M12 13c0-3.5-2.5-6-6.5-6C5.5 11 8 13 12 13Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path
        d="M12 11c0-4 2.8-6.5 7-6.5C19 9 16 11 12 11Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
...
export function ClipboardIcon({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect x="5" y="4.5" width="14" height="16" rx="1.4" stroke="currentColor" strokeWidth="1.6" />
      <rect x="8.5" y="3" width="7" height="3" rx="1" stroke="currentColor" strokeWidth="1.6" />
