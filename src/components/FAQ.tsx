...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "It depends on the format and how often you train, so exact pricing isn't listed here. The free consult covers cost directly, before you commit to anything.",
  },
  {
